...
<a id ="follow" class="follow" onclick='subscribe("<?php echo $current_tag;?>", "<?php echo $current_user_id;?>")'>
<?php if(!$in_my_tag):?>subscribe<?php else:?>cancle subscribe<?php endif;?> 
</a>
                        ...
                        <div id="reply<?php echo $blog->id;?>" style="display:none;">
                            ...
                            <div class="reply_input" id="reply_input<?php echo $blog->id;?>">
                                ...
                                <button type="button" class="button"
                                        onclick='add_reply("<?php echo $blog->id;?>", "<?php echo $current_user_id;?>")'>reply</button>
                            </div>
                            <br/>
